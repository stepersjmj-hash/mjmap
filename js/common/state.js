...
const STATE = {
  ...
  active: { money: false, gas: false, truck: false, street: false, bluer: true, bluer_cafe: false, fav: false },
  markers: { money: [], gas: [], truck: [], street: [], bluer: [], bluer_cafe: [], fav: [] },
  data: { money: [], gas: [], truck: [], street: [], bluer: [], bluer_cafe: [] },
  map: null,
